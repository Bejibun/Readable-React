    ...
    return function wrapWithFormik(WrappedComponent) {
        var Formik = (function (_super) {
            ...
            Formik.prototype.render = function () {
                ...
                return (createElement(WrappedComponent, __assign({}, this.props, this.state, { dirty: dirty, isValid: dirty
                        ? this.state.errors &&
...
export { Formik, yupToFormErrors, validateYupSchema, touchAllFields };
