      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.prev = 3;
            _context.next = 6;
            return (0, _prettierEslint2.default)((0, _extends3.default)({ text: stdinValue }, prettierESLintOptions));
...
function formatFilesFromArgv(_ref) {
  var fileGlobs = _ref._,
      ...
      prettierOptions = (0, _objectWithoutProperties3.default)(_ref, ['_', 'logLevel', 'listDifferent', 'stdin', 'write', 'eslintPath', 'prettierPath', 'ignore', 'eslintIgnore', 'eslintConfigPath', 'prettierLast']);
...
function formatFile(filePath, prettierESLintOptions, cliOptions) {
  ...
  var format$ = rxReadFile(filePath, 'utf8').mergeMap(function (text) {
    var promise = (0, _prettierEslint2.default)((0, _extends3.default)({
      text,
      filePath
    }, prettierESLintOptions)).then(function (formatted) {
      fileInfo.text = text;
